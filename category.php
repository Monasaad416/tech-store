...
$cat_by_id = $c->select_id($id);
$p = new Product;
$prods =  $p->select_where("cat_id = $id", "id,name,img,price")
...
<div class="home">
	...
	<div class="home_content d-flex flex-column align-items-center justify-content-center">
		<?php if (!empty($cat_by_id)) : ?>
			<h2 class="home_title"><?= $cat_by_id['name'] ?></h2>
		<?php else : ?>
							...
							<?php foreach ($prods as $prod) : ?>
								<div class="product_item">
									...
									<div class="product_image d-flex flex-column align-items-center justify-content-center">
										<img src="<?= URL . "uploads/" . $prod['img']; ?> " width="90%" alt="<?= $prod['name']; ?>" />
									</div>
...
<?php else : ?>
	<div class="shop" style="height: 400px;"></div>
<?php endif; ?>
