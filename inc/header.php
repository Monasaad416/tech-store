...
<head>
    ...
    <link rel="stylesheet" href="<?= URL; ?>assets/plugins/fontawesome-free-5.0.1/css/fontawesome-all.css" type="text/css">
                                ...
                                <div class="cart">
                                    <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                                        <div class="cart_icon">
                                            ...
                                            <div class="cart_count"><span><?= $cart_count? $cart_count : 0; ?></span></div>
                                        </div>
                                        <div class="cart_content">
                                            <div class="cart_text"><a href="<?= URL;?>cart.php">Cart</a></div>
                                            <div class="cart_price">$<?= $cart_total ? $cart_total : 0; ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
